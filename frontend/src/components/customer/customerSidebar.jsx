  ...
  const menuSections = [
    {
      ...
      items: [
        ...
        { name: "My Collection", path: "/user/my-collection", icon: Crown },
      ],
    },
    {
      title: "ORDERS & PURCHASES",
      items: [
        { name: "My Orders",   path: "/user/my-orders",   icon: Package },
        { name: "Track Shipment", path: "/user/shipment", icon: Tags },
        { name: "Returns & Refunds",  path: "/user/returns",  icon: Boxes },
      ],
    },
    {
      title: "WHISHLIST & PREFERENCES",
      items: [
        { name: "Wishlist",  path: "/user/whishlist",  icon: ShoppingCart },
        { name: "Price Alerts", path: "/user/price-alerts", icon: Star },
      ],
    },
    {
      title: "ACCOUNT",
      items: [
        { name: "Profile",    path: "/user/profile",          icon: ShieldCheck },
        { name: "Payment",    path: "/user/payment",          icon: ShieldCheck },
        { name: "Address Book",  path: "/user/address-book",  icon: Activity },
    ...
    },
    {
      title: "LOYALTY",
      items: [
        { name: "Membership", path: "/user/membership", icon: Tag },
        { name: "Help Center", path: "/user/help", icon: Tag },
      ],
    },
  ];
        ...
        <div className="shrink-0 border-t border-white/8 p-4">
          ...
          <div className="mb-3 flex items-center gap-3 border border-white/8 bg-white/3 px-3 py-3">
            ...
            <div className="min-w-0">
              <p className="truncate text-xs font-medium text-white leading-none">Customer</p>
